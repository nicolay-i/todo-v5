...
function tryLaunchCopilot({ prompt, worktreePath }) {
    ...
    return new Promise((resolve) => {
        ...
        try {
            ...
            log(COLORS.magenta('Запуск Copilot с рабочей директорией: ' + worktreePath));
            // Подготовим лог-файл
            let logFile = null;
            let logStream = null;
            try {
...
async function main() {
    ...
    const worktreeDirName = `${repoDirName}__${branch.replace(/[\/]/g, '__')}`; // каталог под worktrees с префиксом
